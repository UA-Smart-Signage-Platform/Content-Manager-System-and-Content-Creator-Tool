import { MdOutlineDashboard,MdOutlinePermMedia,
    ...
    MdOutlineBrandingWatermark,MdOutlineWbSunny, MdOutlineSupervisorAccount, MdOutlineLogout, MdOutlineLogin } from "react-icons/md";
...
function NavBar() {
    ...
    return(
        ...
        <div className=" flex flex-col w-[65px] bg-black h-[100vh] gap-10 z-10 text-white fixed"
            ...
            {!isLoggedIn ? 
                (<button className="w-full h-[5%] text-lg justify-evenly cursor-pointer">
                    <MdOutlineLogin className=" h-full w-full px-3.5"/>
                </button>) 
                : 
                (<>
        ...
        <AnimatePresence>
            {isShow && <motion.div className=" flex flex-col w-[10%] bg-black h-[100vh] gap-10 z-0 text-white fixed left-[65px] font-Lexend text-2xl font-semibold"
                ...
                {!isLoggedIn ? 
                (<button className="w-full h-[5%] flex items-center">
                    Sign in
                </button>) 
                : 
                (<>
